...
#Currently working on another way to add the acroform as on the rare chance, the acroform is unable to be added causing a blank page once a while. Credits for the help on this funtion: A_E.
